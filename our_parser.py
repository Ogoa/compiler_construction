...
#TODO:  Add a print_statement under statement
...
class Parser:
    ...
    def program(self):
        ...
        if statement_list_node:
            ...
            # Raise an error if no statement list is found
    ...
    def statement(self):
        ...
        if self.assignment_statement():
            ...
            # Append to the list of errors if no match is found
    ...
    def expect_token(self, expected_token_type):
        """Expects the current token to match the expected token type as identified by the scanner. If a
        match is found, it advances to the next token, otherwise an error message is added to the list 
        of errors and attempts to recover by skipping over tokens until a valid point is reached
